  ...
  useEffect(() => {
    if (document.fonts.status === "loaded") {
      ...
      const readyPromise = document.fonts.ready.then(() => {
        // schedule async update from promise callback (already async)
        setFontsLoaded(true);
      });
      // optional: avoid unhandled promise on unmount (no cancellation API for fonts.ready)
      return () => {
        // noop cleanup to satisfy effect return type; readyPromise will simply settle
      };
    }
  }, []);
